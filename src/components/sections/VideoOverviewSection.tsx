...
export function VideoOverviewSection() {
  return (
    <section id="video-overview" aria-labelledby="video-overview-heading" className="bg-white py-20 sm:py-24 lg:py-28">
      <Container>
        ...
        <div className="video-container">
          <video controls preload="none" playsInline poster="/assets/LIF_video_cover.jpeg">
